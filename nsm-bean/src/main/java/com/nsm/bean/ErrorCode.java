...
public class ErrorCode {
    public static final ErrorCode OK = new ErrorCode(200, "成功");
    ...
    public static final ErrorCode AUTHENTICATION_FAILURE = new ErrorCode(600, "认证失败");
    public static final ErrorCode NO_AUTHENTICATION = new ErrorCode(601, "没有认证");
    ...
    public static final ErrorCode NO_PERMISSION = new ErrorCode(1005, "没有权限");
